...
WebBodyWebSub $WebBodyWebSubFromJson(Map<String, dynamic> json) {
	...
	if (webSubId != null) {
		webBodyWebSub.webSubId = webSubId;
	}
	final List<WebBodyWebSubWebDetail>? webDetail = jsonConvert.convertListNotNull<WebBodyWebSubWebDetail>(json['webDetail']);
	if (webDetail != null) {
...
WebBodyWebSubWebDetail $WebBodyWebSubWebDetailFromJson(Map<String, dynamic> json) {
	final WebBodyWebSubWebDetail webBodyWebSubWebDetail = WebBodyWebSubWebDetail();
	final int? webDetailId = jsonConvert.convert<int>(json['webDetailId']);
	if (webDetailId != null) {
		webBodyWebSubWebDetail.webDetailId = webDetailId;
	}
	final int? webId = jsonConvert.convert<int>(json['webId']);
	if (webId != null) {
		webBodyWebSubWebDetail.webId = webId;
	}
	final int? webSubId = jsonConvert.convert<int>(json['webSubId']);
	if (webSubId != null) {
		webBodyWebSubWebDetail.webSubId = webSubId;
	}
...
Map<String, dynamic> $WebBodyWebSubWebDetailToJson(WebBodyWebSubWebDetail entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
	data['webDetailId'] = entity.webDetailId;
	data['webId'] = entity.webId;
	data['webSubId'] = entity.webSubId;
