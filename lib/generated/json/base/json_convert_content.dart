...
import 'package:grocery/generated/json/profile.g.dart';
...
import 'package:grocery/generated/json/retrofit_dept.g.dart';
...
class JsonConvert {
  ...
  T? asT<T extends Object?>(dynamic value) {
	...
	static M? _fromJsonSingle<M>(Map<String, dynamic> json) {
		...
		if(type == (DeptEntity).toString()){
			return DeptEntity.fromJson(json) as M;
		}
		if(type == (RetrofitDept).toString()){
			return RetrofitDept.fromJson(json) as M;
		}
		if(type == (WebEntity).toString()){
			return WebEntity.fromJson(json) as M;
		}
		if(type == (WebBody).toString()){
			return WebBody.fromJson(json) as M;
		}
		if(type == (WebBodyWebSub).toString()){
			return WebBodyWebSub.fromJson(json) as M;
		}
